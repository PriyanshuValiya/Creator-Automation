...
const categories = ["Motivation", "Finance", "Technology", "AI News", "Trends", "Brands"];
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-10 flex flex-col items-center">
      ...
      <p className="text-gray-600 mt-3 text-center max-w-lg">
        Get creative and boost engagement with fresh content ideas powered by AI.
      </p>

      {/* Category Selection */}
      <div className="mt-6">
        <label className="text-gray-700 font-medium mr-3">Choose Category:</label>
        <select
      ...
      {ideas.length > 0 ? (
        ...
        <p className="mt-6 text-gray-500">No ideas generated yet. Click the button below to get started!</p>
      )}
      ...
      <motion.button 
        ...
        disabled={loading}
      >
        <Sparkles className="mr-2" /> {loading ? "Generating..." : "Generate Ideas"}
      </motion.button>
    </div>
  );
}
