    ...
    <div className="flex h-screen bg-gray-50 text-gray-900">
      ...
      >
        <button onClick={() => setSidebarOpen(!sidebarOpen)} className="p-2">
          {sidebarOpen ? <X size={24} className="mx-44" /> : <Menu size={24} className="-mx-3" />}
        </button>
        {sidebarOpen && (
          <>
      ...
      <div className="flex-1 flex flex-col p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-xl shadow border-l-8 border-gray-800">
            <h3 className="text-lg font-semibold">✍️ Manual Post Creation</h3>
            <p className="text-gray-600 mt-3">
              Create posts manually for full control. Perfect for customized content.
            </p>
          ...
          <div className="bg-white p-6 rounded-xl shadow border-l-8 border-gray-800">
            <h3 className="text-lg font-semibold">🤖 AI-Powered Post Creation</h3>
            <p className="text-gray-600 mt-3">
            ...
            <ul className="list-disc list-inside text-gray-700 mt-3 space-y-2">
              ...
              <li>AI generates an engaging post optimized for your audience.</li>
