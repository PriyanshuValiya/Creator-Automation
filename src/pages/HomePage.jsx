...
export default function HomePage() {
  ...
  if (!isLoaded || isSignedIn) {
    return <div className="min-h-screen flex items-center justify-center bg-gray-50 text-gray-800">Hang tight! We're setting things up for you...</div>;
  }
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 text-gray-800">
      ...
      <div className="py-20 bg-white">
        ...
        <p className="text-center text-gray-600 mt-4 max-w-2xl mx-auto">
          Explore powerful AI tools designed to make your Instagram content creation seamless and effective.
        </p>
...
const features = [
  { title: "AI-Powered Post Generation", description: "Generate high-quality Instagram posts instantly using AI.", icon: "🤖" },
  { title: "Automated Hashtags & Captions", description: "Get optimized hashtags and captions for better reach.", icon: "🏷️" },
  { title: "Download AI-Generated Images & Email Delivery", description: "Save AI-created images locally and receive them via email.", icon: "📥" },
  { title: "Post Preview & Customization", description: "Edit, preview, and tweak your posts before publishing.", icon: "✍️" },
  { title: "Multi-Format Support", description: "Supports images, videos, and carousel posts.", icon: "📸" },
  { title: "Generate Trending Post Ideas", description: "Get AI-suggested trending ideas for reels and images.", icon: "🔥" },
];
